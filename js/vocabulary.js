...
export const vocabulary = [
  // 1~10 關：主題式基礎單字
  { level: 1, word: 'CAT',   length: 3, category: '動物夥伴（1-3關）', definition: '貓',    partOfSpeech: 'n.', example: 'The cat is sleeping.',         exampleZh: '這隻貓正在睡覺。', image: 'img/cat.png' },
  { level: 2, word: 'DOG',   length: 3, category: '動物夥伴（1-3關）', definition: '狗',    partOfSpeech: 'n.', example: 'The dog runs fast.',           exampleZh: '這隻狗跑得很快。', image: 'img/dog.png' },
  { level: 3, word: 'FISH',  length: 4, category: '動物夥伴（1-3關）', definition: '魚',    partOfSpeech: 'n.', example: 'A fish swims in water.',       exampleZh: '魚在水裡游泳。', image: 'img/fish.png' },

  { level: 4, word: 'BAG',   length: 3, category: '校園用品（4-6關）', definition: '書包',  partOfSpeech: 'n.', example: 'This is my bag.',              exampleZh: '這是我的書包。', image: 'img/bag.png' },
  { level: 5, word: 'PEN',   length: 3, category: '校園用品（4-6關）', definition: '原子筆',partOfSpeech: 'n.', example: 'I have a pen.',                 exampleZh: '我有一支原子筆。', image: 'img/pen.png' },
  { level: 6, word: 'BOOK',  length: 4, category: '校園用品（4-6關）', definition: '書',    partOfSpeech: 'n.', example: 'This is my book.',              exampleZh: '這是我的書。', image: 'img/book.png' },

  { level: 7, word: 'BED',   length: 3, category: '居家物品（7-8關）', definition: '床',    partOfSpeech: 'n.', example: 'I sleep on the bed.',           exampleZh: '我睡在床上。', image: 'img/bed.png' },
  { level: 8, word: 'FAN',   length: 3, category: '居家物品（7-8關）', definition: '電風扇',partOfSpeech: 'n.', example: 'Turn on the fan.',              exampleZh: '把電風扇打開。', image: 'img/fan.png' },

  { level: 9,  word: 'RUN',  length: 3, category: '動作練習（9-10關）', definition: '跑步',  partOfSpeech: 'v.', example: 'I can run fast.',               exampleZh: '我可以跑得很快。', image: 'img/run.png' },
  { level:10,  word: 'JUMP', length: 4, category: '動作練習（9-10關）', definition: '跳',    partOfSpeech: 'v.', example: 'Can you jump high?',            exampleZh: '你能跳得高嗎？', image: 'img/jump.png' },
  ...
  // 21~30 關：維持可理解的分類
  { level:21, word: 'APPLE',  length: 5, category: '生活常見（21-25關）', definition: '蘋果',   partOfSpeech: 'n.',  example: 'I eat an apple.',            exampleZh: '我吃一顆蘋果。', image: 'img/apple.png' },
  { level:22, word: 'CHAIR',  length: 5, category: '生活常見（21-25關）', definition: '椅子',   partOfSpeech: 'n.',  example: 'Sit on the chair.',          exampleZh: '坐在椅子上。', image: 'img/chair.png' },
  { level:23, word: 'SHEEP',  length: 5, category: '生活常見（21-25關）', definition: '綿羊',   partOfSpeech: 'n.',  example: 'A sheep is white.',          exampleZh: '綿羊是白色的。', image: 'img/sheep.png' },
  { level:24, word: 'BLACK',  length: 5, category: '生活常見（21-25關）', definition: '黑色',   partOfSpeech: 'adj.',example: 'My hair is black.',         exampleZh: '我的頭髮是黑色的。', image: 'img/black.png' },
  { level:25, word: 'ORANGE', length: 6, category: '生活常見（21-25關）', definition: '柳橙',   partOfSpeech: 'n.',  example: 'Orange juice is tasty.',     exampleZh: '柳橙汁很好喝。', image: 'img/orange.png' },
